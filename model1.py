...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma,
        ...
        # self.entity_embedding_rota = nn.Embedding(nentity, self.hidden_dim * 2)
    ...
    def adapt_bi(self, head, relation, tail, mode):
        ...
        er2 = torch.cat([e2, r2], dim=-1)
        er2 = self.er_fc_1(er2)
        score2 = e2 * er2 - e1
        score2 = self.gamma.item() - torch.norm(score2, 1, -1)
            ...
            with torch.no_grad():
                ...
                for test_mode in test_mode:
                    ...
                    if True:
                        ...
                        if test_step % (args.valid_steps * 5) == 0:
                            print(f'{mode:^100}')
